...
- Bump JavaScript SDK from v9.40.0 to v10.14.0 ([#22](https://github.com/inti7ary/sentry-dart/pull/22))
  - [changelog](https://github.com/getsentry/sentry-javascript/blob/develop/CHANGELOG.md#10140)
  - [diff](https://github.com/getsentry/sentry-javascript/compare/9.40.0...10.14.0)
