...
- Bump JavaScript SDK from v9.40.0 to v10.12.0 ([#18](https://github.com/inti7ary/sentry-dart/pull/18))
  - [changelog](https://github.com/getsentry/sentry-javascript/blob/develop/CHANGELOG.md#10120)
  - [diff](https://github.com/getsentry/sentry-javascript/compare/9.40.0...10.12.0)
