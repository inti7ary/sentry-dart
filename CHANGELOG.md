...
- Bump JavaScript SDK from v9.40.0 to v10.15.0 ([#25](https://github.com/inti7ary/sentry-dart/pull/25))
  - [changelog](https://github.com/getsentry/sentry-javascript/blob/develop/CHANGELOG.md#10150)
  - [diff](https://github.com/getsentry/sentry-javascript/compare/9.40.0...10.15.0)
