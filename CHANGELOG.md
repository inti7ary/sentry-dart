...
- Bump JavaScript SDK from v9.40.0 to v10.11.0 ([#15](https://github.com/inti7ary/sentry-dart/pull/15))
  - [changelog](https://github.com/getsentry/sentry-javascript/blob/develop/CHANGELOG.md#10110)
  - [diff](https://github.com/getsentry/sentry-javascript/compare/9.40.0...10.11.0)
