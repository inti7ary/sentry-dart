...
- Bump JavaScript SDK from v9.40.0 to v10.10.0 ([#13](https://github.com/inti7ary/sentry-dart/pull/13))
  - [changelog](https://github.com/getsentry/sentry-javascript/blob/develop/CHANGELOG.md#10100)
  - [diff](https://github.com/getsentry/sentry-javascript/compare/9.40.0...10.10.0)
