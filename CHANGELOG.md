...
- Bump JavaScript SDK from v9.40.0 to v10.13.0 ([#20](https://github.com/inti7ary/sentry-dart/pull/20))
  - [changelog](https://github.com/getsentry/sentry-javascript/blob/develop/CHANGELOG.md#10130)
  - [diff](https://github.com/getsentry/sentry-javascript/compare/9.40.0...10.13.0)
